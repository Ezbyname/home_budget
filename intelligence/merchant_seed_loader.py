...
MERCHANT_SEEDS: list[tuple[str, str, str, float]] = [
    ...
    ('CITY_MARKET',     'סיטי מרקט',        'food',         0.85),
    ('KIOSK_MARKET',    'קיוסק מרקט',       'food',         0.80),
    ('KOLBO',           'כלבו',             'food',         0.80),
    # Subscriptions — additional
    ('OPENAI_CHATGPT',  'OpenAI / ChatGPT', 'subscriptions', 0.95),
    ('MICROSOFT',       'Microsoft',        'subscriptions', 0.85),
    ('CANVA',           'Canva',            'subscriptions', 0.90),
    ('DROPBOX',         'Dropbox',          'subscriptions', 0.90),
    ('ADOBE',           'Adobe',            'subscriptions', 0.90),
    # Clothing — additional
    ('MAX_FASHION',     'מקס פשיון',        'clothing',     0.90),
    ('RENUAR',          'רנואר',            'clothing',     0.85),
    ('KENVELO',         'קנבלו',            'clothing',     0.85),
    ('TERMINAL_X',      'טרמינל X',         'clothing',     0.85),
    # Health / Beauty — additional
    ('IHERB',           'iHerb',            'health_beauty', 0.90),
    ('HAIR_COSMETICS',  'HAIR COSMETICS',   'health_beauty', 0.80),
    # Transport — public
    ('DAN_BUS',         'דן תחבורה',        'vehicle',      0.90),
    ('EGGED_BUS',       'אגד',              'vehicle',      0.90),
    ('ISRAEL_RAIL',     'רכבת ישראל',       'vehicle',      0.90),
    # Education
    ('AGUSH_EDU',       'אגוש / בתי ספר',   'education',    0.80),
    # Entertainment
    ('ENTERTAINMENT',   'בידור',            'entertainment', 0.75),
    ('CINEMA',          'קולנוע',           'entertainment', 0.90),
    # Sport / Gym
    ('GYM',             'מועדון כושר',      'health_beauty', 0.85),
    # Parking / Transport
    ('PANGO_PARKING',   'פנגו חניון',       'vehicle',      0.90),
    ('DOR_ALON',        'דור אלון',         'vehicle',      0.85),
    # Insurance — additional
    ('CREDIT_CARD_FEE', 'דמי כרטיס אשראי',  'misc',         0.90),
    ('CASHBACK',        'החזר קאשבק',       'misc',         0.95),
    # Electronics
    ('KSP_ELECTRONICS', 'KSP אלקטרוניקה',  'misc',         0.80),
    # Subscriptions — Claude AI
    ('ANTHROPIC_CLAUDE','Claude AI',        'subscriptions', 0.95),
]
